...
- ✅ **Стандартная страница ошибки:** Добавить стандартную страницу для сообщения об ошибке пользователю
- ✅ **Контейнеризация frontend приложения:** Создать Dockerfile для frontend приложения и добавить его в docker compose
